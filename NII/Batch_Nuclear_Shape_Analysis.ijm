...
// edit the processFile() function at the end of this macro.
  ...
  function processFile(path) {
       ...
       if (endsWith(path, ".czi") & (name != "gatta")) {
			...
			// here the macro stops to give you time to delete the ROIs of unsegmented cells manually, press ok when done
						...
						outPath = "C:/Users/Jack/Documents/GitHub/Chromatin_Remodeling_Image_Processing/NII/" + name + "/";
						
						roiManager("save", outPath + name + "_RoiSet.zip");
			...
			Table.create("Final results");
				...
				saveAs("Results", outPath + name +"_CompleteResults.txt");
					
					selectWindow(name + "_CompleteResults.txt");	
					run("Close");
